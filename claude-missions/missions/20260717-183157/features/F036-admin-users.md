...
- AS-065 (user list with signup dates and counts)

## Draft scope
- User table: email, signup date, onboarded, last activity; total counts header
- Read via service-role server-side only

## Files (approximate)
src/app/admin/korisnici/page.tsx
...
## Clarified implementation (from clarifications/F036-clarification.md)
