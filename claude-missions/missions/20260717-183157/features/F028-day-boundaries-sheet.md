# F028: Belgrade day boundaries + "+" bottom sheet
...
- AS-046 (Europe/Belgrade day assignment), AS-051 (any log method within 2 taps)

## Draft scope
- Day-boundary utility (Europe/Belgrade) used by all queries/aggregations (+ tests)
- Floating "+" button → bottom sheet: Pretraži / Skeniraj barkod / Slikaj deklaraciju / Slikaj obrok
- Photo options stubbed/disabled until M7 with "uskoro" label

## Files (approximate)
src/lib/dates.ts (+ tests), src/components/home/AddSheet.tsx
