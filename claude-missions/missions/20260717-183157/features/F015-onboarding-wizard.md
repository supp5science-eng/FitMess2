...
- AS-018 (routed before home), AS-019 (collects sex, age, height, weight, activity, goal)

## Draft scope
- Multi-step wizard, one question per screen, progress indicator, Serbian copy (ti form)
- Steps: pol, godine, visina, težina, aktivnost (5 tiers), cilj (target kg + weeks)
- Client-side validation with sensible ranges

## Files (approximate)
src/app/(app)/onboarding/, src/components/onboarding/
...
## Clarified implementation (from clarifications/F015-clarification.md)
