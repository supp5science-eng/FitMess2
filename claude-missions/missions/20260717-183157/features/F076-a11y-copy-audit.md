# F076: Accessibility + Serbian copy audit pass
...
- AS-124 (sr-Latn "ti" form everywhere), AS-125 (375px), AS-126 (desktop column), AS-127 (light theme consistency), AS-128 (labels, alt text, keyboard reachability)

## Draft scope
- Sweep all screens: labels on inputs, alt texts, focus states, contrast on accent color
- Copy audit: consistent ti-form Serbian, no translated-sounding phrasing, no shame language
- 375px layout check on every core screen

## Files (approximate)
touch-ups across components
...
## Clarified implementation (from clarifications/F076-clarification.md)
