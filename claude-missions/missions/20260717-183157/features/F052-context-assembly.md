# F052: Server-side agent context assembly

**Milestone:** M6 — Agent
**Estimated worker time:** 45 minutes
**Depends on:** F050, F046

## Assertion IDs covered
- AS-093 (assembled context matches DB state for remaining daily/weekly)

## Draft scope
- buildAgentContext(userId): profile, targets, effective remaining today + this week, last 7 days of logs, weight trend, past conversation summaries
- Injected into system prompt server-side per request; deterministic ordering for prompt caching
- Unit test comparing context numbers to seeded DB fixture

## Files (approximate)
src/lib/ai/context.ts (+ tests)
...
## Clarified implementation (from clarifications/F052-clarification.md)
