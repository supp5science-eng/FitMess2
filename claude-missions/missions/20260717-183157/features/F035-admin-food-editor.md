# F035: Admin food editor + scan-to-create

**Milestone:** M4 — Barcode & Admin
**Estimated worker time:** 45 minutes
**Depends on:** F034, F030

## Assertion IDs covered
- AS-061 (edit name/brand/nutrition), AS-064 (scan barcode to create/open product)

## Draft scope
- Full food edit form (all fields incl. common units editor, barcode)
- Scan button in admin: decoded GTIN opens existing product or new-product form with GTIN set, mark verified on save
- Supports the admin manual-seeding workflow from PRD Addendum 1

## Files (approximate)
src/app/admin/hrana/[id]/page.tsx, src/app/admin/hrana/novi/page.tsx
...
## Clarified implementation (from clarifications/F035-clarification.md)
