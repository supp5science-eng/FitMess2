...
export const analyticsMessages = {
  sr: {
    ...
    "analytics.intake.note.noData": "Procena je preciznija sa više upisanih obroka",
    ...
    "analytics.micro.day.goalMet": "Na preporuci ({target}) 🎉",
    "analytics.micro.day.goalShort": "{diff} do preporuke ({target})",
  ...
  en: {
    ...
    "analytics.intake.note.noData": "The estimate sharpens as more meals are logged",
    ...
    "analytics.micro.day.goalMet": "At the recommendation ({target}) 🎉",
    "analytics.micro.day.goalShort": "{diff} to the {target} recommendation",
