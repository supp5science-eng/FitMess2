// Core / shared UI copy (nav, settings, home dashboard). One namespace module
// per feature area lives beside this file; `../messages.ts` merges them all.
// Serbian (`sr`) is the source of truth for the key set; `en` is typed against
// it, so a missing English string fails the build.
