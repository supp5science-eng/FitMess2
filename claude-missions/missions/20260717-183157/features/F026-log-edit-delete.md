...
- AS-044 (edit portion recalculates), AS-045 (delete recalculates)

## Draft scope
- Tap meal card → edit sheet (portion) or delete with confirm
- Totals and ring recompute immediately

## Files (approximate)
src/components/food/MealCard.tsx, log actions
...
## Clarified implementation (from clarifications/F026-clarification.md)
