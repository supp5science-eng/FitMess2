# F077: README/docs + deploy checklist
...
- AS-129 (README documents setup, env vars, commands), AS-003 (env example re-verified complete)

## Draft scope
- README: project overview, setup, env var table, run/test/lint/typecheck commands, deploy notes, cron list
- Verify .env.example completeness against actual usage
- Beta launch checklist (Supabase settings, Vercel env, push keys, admin flag)
...
## Clarified implementation (from clarifications/F077-clarification.md)
