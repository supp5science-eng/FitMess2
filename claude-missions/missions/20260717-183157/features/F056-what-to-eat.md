# F056: "Šta sad da pojedem?" quick action
...
- AS-094 (2–3 concrete suggestions fitting remaining kcal + protein)

## Draft scope
- Quick action button (home + chat) sending templated request with remaining kcal/protein from context
- Suggestions from Serbian cuisine / common store products with rough amounts; rendered as cards
- Counts toward the 30-message agent cap

## Files (approximate)
chat quick-action wiring, prompt template in src/lib/ai/prompts.ts
...
## Clarified implementation (from clarifications/F056-clarification.md)
