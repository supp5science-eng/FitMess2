# F066: Label photo retention for admin review

**Milestone:** M7 — Vision
**Estimated worker time:** 15 minutes
**Depends on:** F062, F034

## Assertion IDs covered
- AS-110 (label photos retained, linked to food record, visible in admin review)

## Draft scope
- Persist label photo path on the created food record
- Admin review queue shows the label photo next to extracted values for verification

## Files (approximate)
foods.label_photo_path usage, admin queue component
...
## Clarified implementation (from clarifications/F066-clarification.md)
