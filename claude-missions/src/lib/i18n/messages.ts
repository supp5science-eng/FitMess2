...
const sr = {
  ...
  "agent.voice.mic":
    "Ne mogu da pristupim mikrofonu. Dozvoli mikrofon pa probaj ponovo.",
  "agent.voice.error": "Nismo uspeli da razumemo snimak. Probaj ponovo.",
  "agent.empty":
  ...
  "agent.chip.protein": "Loguj mi obrok",
  "agent.greeting.morning": "Dobro jutro",
  "agent.greeting.day": "Dobar dan",
  ...
  "agent.action.slikaj_obrok.desc": "Najbrže — jedan okidač",
  "agent.action.gric.title": "Samo mi reci",
  "agent.action.gric.desc": "„Dva jaja i jogurt“ — upisujem",
  "agent.action.deklaracija.title": "Slikaj deklaraciju",
  "agent.action.deklaracija.desc": "Podaci sa pakovanja",
  "agent.action.trening.title": "Upiši trening",
  "agent.action.trening.desc": "Aktivnost i trajanje",
  "agent.action.danas.title": "Današnji pregled",
  "agent.action.danas.desc": "Ring, obroci, voda, koraci",
  "agent.action.analitika.title": "Analitika",
  "agent.action.analitika.desc": "Nedelja, trendovi, istorija",
  "agent.action.merenje.title": "Upiši težinu",
  "agent.action.merenje.desc": "Nedeljno merenje",
  "agent.action.podesavanja.title": "Podešavanja",
  "agent.action.podesavanja.desc": "Cilj, podaci, podsetnici",
...
const en: Record<MessageKey, string> = {
  ...
  "agent.voice.error": "We couldn't make out the clip. Try again.",
  ...
  "agent.chip.protein": "Log a meal for me",
  "agent.greeting.morning": "Good morning",
  "agent.greeting.day": "Good afternoon",
  ...
  "agent.action.slikaj_obrok.desc": "Fastest — one shutter",
  "agent.action.gric.title": "Just tell me",
  "agent.action.gric.desc": "“Two eggs and yogurt” — I'll log it",
  "agent.action.deklaracija.title": "Snap a label",
  "agent.action.deklaracija.desc": "Data from the packaging",
  "agent.action.trening.title": "Log a workout",
  "agent.action.trening.desc": "Activity and duration",
  "agent.action.danas.title": "Today's overview",
  "agent.action.danas.desc": "Ring, meals, water, steps",
  "agent.action.analitika.title": "Analytics",
  "agent.action.analitika.desc": "Week, trends, history",
  "agent.action.merenje.title": "Log your weight",
  "agent.action.merenje.desc": "Weekly weigh-in",
  "agent.action.podesavanja.title": "Settings",
  "agent.action.podesavanja.desc": "Goal, data, reminders",
