export const appMessages = {
  sr: {
    ...
    // Landing hero demo (decorative in-app re-enactment)
    "app.demo.wd.mon": "pon",
    "app.demo.wd.tue": "uto",
    "app.demo.wd.wed": "sre",
    "app.demo.wd.thu": "čet",
    "app.demo.wd.fri": "pet",
    "app.demo.meal.chickenRice": "Piletina sa pirinčem",
    "app.demo.meal.omelet": "Omlet sa sirom",
    "app.demo.cam.title": "Slikaj obrok",
    "app.demo.cam.cancel": "Otkaži",
    "app.demo.cam.hint": "AI će proceniti kalorije i makronutrijente",
    "app.demo.analyze": "Analiziram obrok…",
    "app.demo.res.confidence": "Visoka sigurnost",
    "app.demo.res.chip.chicken": "piletina",
    "app.demo.res.chip.rice": "pirinač",
    "app.demo.res.chip.broccoli": "brokoli",
    "app.demo.res.name": "Naziv",
    "app.demo.res.grams": "Gramaža (g)",
    "app.demo.res.kcal": "Kalorije",
    "app.demo.res.protein": "Protein (g)",
    "app.demo.res.carbs": "Ugljeni hidrati (g)",
    "app.demo.res.fat": "Masti (g)",
    "app.demo.res.add": "Dodaj u dan",
    "app.demo.res.note": "AI procena je približna — proveri i doteraj po potrebi.",
  ...
  en: {
    ...
    "app.demo.wd.thu": "thu",
    "app.demo.wd.fri": "fri",
    "app.demo.meal.chickenRice": "Chicken with rice",
    "app.demo.meal.omelet": "Cheese omelet",
    "app.demo.cam.title": "Snap a meal",
    "app.demo.cam.cancel": "Cancel",
    "app.demo.cam.hint": "AI will estimate the calories and macros",
    "app.demo.analyze": "Analyzing meal…",
    "app.demo.res.confidence": "High confidence",
    "app.demo.res.chip.chicken": "chicken",
    "app.demo.res.chip.rice": "rice",
    "app.demo.res.chip.broccoli": "broccoli",
    "app.demo.res.name": "Name",
    "app.demo.res.grams": "Weight (g)",
    "app.demo.res.kcal": "Calories",
    "app.demo.res.protein": "Protein (g)",
    "app.demo.res.carbs": "Carbs (g)",
    "app.demo.res.fat": "Fat (g)",
    "app.demo.res.add": "Add to day",
    "app.demo.res.note": "The AI estimate is approximate — check and adjust as needed.",
